        ...
        <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
            <div class="main-card mb-3 card">
                <div class="card-body">
                    ...
                    <h5 class="card-title" style="color:#3f6ad8;">Cadastrar:</h5><br/>

                    <form role="form" method="POST" action="{{route('insertCargo')}}" enctype="multipart/form-data">
                    @csrf 
                        <div class="position-relative row form-group">
                            <label for="exampleEmail" class="col-sm-2 col-form-label">Nome<small style="color:red;">*</small>:</label>
                            <div class="col-sm-10">
                                <input type="text" name="nome" class="form-control is-valid" id="validationServer01" style="background-color:transparent; border: 1px solid #cccccc;" required>
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="cargo" class="form-control is-valid" id="validationServer01" style="border: 1px solid #cccccc;" required>
                                <small id="emailHelp" class="form-text text-muted">*campo obrigatorio.</small>
                            </div>
                        </div>
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="email" class="form-control is-valid" id="validationServer01" style="border: 1px solid #cccccc;" required>
                                <small id="emailHelp" class="form-text text-muted">*campo obrigatorio.</small>
                            </div>
                        </div>
                        ...
                        <div class="position-relative row form-group" style="margin-top:10px;">
                            ...
                            <div class="col-sm-10">
                                <textarea type="text" name="descricao" class="form-control" id="open-source-plugins" style="height:200px;" aria-describedby=""></textarea>
                                  <script>
